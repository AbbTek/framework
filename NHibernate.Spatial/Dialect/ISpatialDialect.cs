...
namespace NHibernate.Spatial.Dialect
{
	...
	public interface ISpatialDialect
	{
		...
		/// <returns>A SqlString object containing
		...
		/// <returns>A SqlString object containing
		/// a SQL spatial relation expression</returns>
		SqlString GetSpatialFilterString(string tableAlias, string geometryColumnName, string primaryKeyColumnName, string tableName, Parameter param);
		...
		/// <returns></returns>
		string GetSpatialCreateString(string schema, string table, string column, int srid, string subtype);
