...
namespace NHibernate.Spatial.Dialect
{
    ...
    public abstract class MsSql2012SpatialDialect : MsSql2012Dialect, ISpatialDialect
	{
        ...
        protected override void RegisterFunctions()
		{
            ...
            RegisterFunction("newid", new NoArgSQLFunction("newid", NHibernateUtil.Guid));
		}
		...
		public SqlString GetSpatialAnalysisString(object geometry, SpatialAnalysis analysis, object extraArgument)
		{
			switch (analysis)
			{
				...
				case SpatialAnalysis.Union:
					...
					{
						extraArgument = Convert.ToString(((object[])extraArgument).First(), NumberFormatInfo.InvariantInfo);
					}
					return new SqlStringBuilder()
						.AddObject(geometry)
						.Add(".ST")
		...
		/// <param name="geometryColumnName"></param>
